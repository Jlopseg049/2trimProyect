...
class getSecurityControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.VY4xALm'] ?? $container->load('get_ServiceLocator_VY4xALmService'))->withContext('App\\Controller\\SecurityController', $container));

 ...
 */
class getRutinaRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RutinaRepository' shared autowired service.
     *
     * @return \App\Repository\RutinaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RutinaRepository.php';

        return $container->privates['App\\Repository\\RutinaRepository'] = new \App\Repository\RutinaRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
